...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IUnitOfWork unitOfWork, /*IMessageRepository messageRepository,*/ IMapper mapper, /*IUserRepository userRepository,*/ //kada budemo slali poruku mapiracemo je u Dto
